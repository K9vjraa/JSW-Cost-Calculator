      ...
      <CardContent className="p-5 flex-1 flex flex-col justify-between overflow-y-auto scrollbar-thin gap-4">
        ...
        <div className="space-y-4 pt-4 border-t border-slate-150">
          <div className="space-y-2 text-xs">
            ...
            {/* GST Rate Selector & Display */}
            <div className="flex flex-col gap-1.5 pt-1.5 border-t border-dashed border-slate-100">
              <div className="flex justify-between items-center text-slate-500 font-semibold">
                <span>GST (Rate: {gstRate}%)</span>
                <span className="font-bold text-slate-800">{inr(gstAmount)}</span>
              </div>
              <div className="flex gap-1">
                {[0, 5, 12, 18].map((rate) => (
                  <button
                    ...
                    className={`flex-1 py-1 text-[10px] font-extrabold rounded border transition-colors ${
                      gstRate === rate
            ...
            {/* Additional Charges Input & Display */}
            <div className="flex justify-between items-center text-slate-500 font-semibold pt-1.5 border-t border-dashed border-slate-100 gap-4">
              ...
              <Input
                ...
                className="h-7 text-xs font-bold py-0.5 px-1.5 w-24 text-right rounded-md bg-white border border-slate-200"
                placeholder="0"
              />
            </div>
          </div>
