...
-- AlterTable
ALTER TABLE "PriceHistory" DROP COLUMN "updatedById",
...
CREATE TABLE "ferro_alloy_master" (
    ...
    "CURRENT_RATE" DECIMAL(16,4) NOT NULL DEFAULT 0,
    "UPDATED_BY_ID" UUID,
    "CREATED_AT" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "UPDATED_AT" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "ferro_alloy_master_RAW_MAT_ID_key" ON "ferro_alloy_master"("RAW_MAT_ID");

-- CreateIndex
CREATE INDEX "ferro_alloy_master_ALLOY_NAME_IS_AVAIL_idx" ON "ferro_alloy_master"("ALLOY_NAME", "IS_AVAIL");
